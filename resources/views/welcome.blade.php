                            ...
                            <div class="container-fluid">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand" href="#home">
                                        <img src="{{url('/images/logo-car-company.svg')}}" />
                                    </a>
                                </div>
                            ...
                            <div class="main_home_slider text-center">
                                <div class="single_home_slider">
                                    <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                        ...
                                        <div class="home_btn">
                                            <a href="#" class="btn btn-lg m_t_10">¡ESTRENA UN AUTO!</a>
                                                ...
                                                <form action="#" id="formid">
                                                    <div
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label for="payment" class="text-start">Pago Inicial</label>
                                                        ...
                                                        <div class="">
                                                            <input type="submit" value="CALCULAR" class="btn btn-lg btn_main_trial_area">
                                                        </div>
                                                    </div>
                                                </form>
                                        </div>
            ...
            <div class="row">
                <div class="main_pricing_area sections">
                    <div class="head_title text-center">
                        <h2>OUR PRICING</h2>
                        <div class="subtitle">
                            A 30 days free trial for all. A brief story about how this process works, keep an eye
                            till the end.
                        </div>
                        <div class="separator"></div>
                    ...
                    <div class="row">
                        <div class="main_trial">
                            <div class="col-sm-12">
                                ...
                                <a href="" class="btn btn-lg btn_main_trial_area">start free trial</a>
                            </div>
                        </div>
                    </div>
                </div>
